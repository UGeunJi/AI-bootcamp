...
import os
image_path = os.path.dirname(os.path.abspath(__file__)) + "/fdb66xv.jpeg"
...
st.image("https://imgur.com/gallery/EyRh1tt")
st.image("https://imgur.com/gallery/SWVKWo4")
st.write(
    """
    ## 사용법
...
# 이미지 1장, 오디오링크 1개, html 코드를 st.write(명령어 안에 넣어서 화면에 출력)채